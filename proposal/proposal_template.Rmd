...
At present, we hypothesize that Asian people will have significantly greater average hours spent at home than white people as they had 0.7 times the hospitalization rate of white people (CDC, 2020). We also hypothesize that people with incomes over $150,000 will have greater average hours spent at home due to essential workers, whose incomes are lower on average, being required to leave home for work. To achieve these results, we would need significant p-values of under 0.05 from our t-tests. The 95% confidence intervals for mean hours spent at home should also completely overlap infrequently. The table and graph below give us a preliminary idea of the differences in average hours spent home among different populations such as urban vs. rural and between different races. 
