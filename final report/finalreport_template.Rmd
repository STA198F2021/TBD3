...
To understand the population, we visualized the racial composition of the sample and the associated mean number of hours spent at home with each race. We found that 88.5% of the sample was composed of Hispanic non-white individuals, with the next most represented racial groups being Asians (4.93%) followed by African Americans (1.66%). 
...
```{r confidence_interval_plots, echo = FALSE, warning=FALSE}
...
```
```{r visualize_grocery_shopping_logistic_regression, warning = FALSE}
# grocery shopping
